...
<div class="menubar"><?php include "menubar.php";?></div>
		...
		<div class="wrapper">	
			<div class="content">
				<div class="prompt">
					<p style="font-family: Verdana;font-size:16px; text-align:center;">Add New Candidate</p>
					<form name="signin" id="signin" method="post" action="addnewcandidate_handler.php" enctype="multipart/form-data">
						<p>
						...
						<p>
							...
							<textarea rows="5" name="description" class="input"></textarea>
						</p>
						<p>
